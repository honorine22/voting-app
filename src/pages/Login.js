        ...
        <div className='forms'>
            ...
            <div class="d-md-flex mt-lg-5 d-lg-flex d-sm-block align-items-center justify-content-center">
                <div className='d-flex mt-lg-5 col-sm-12 col-md-5 col-lg-2'>
                    <img className='w-100 position-relative py-5' src={formImg} alt='header Image' />
                ...
                <form class="bg-white mt-lg-5 col-sm-12 col-md-6 col-lg-3 rounded-3 shadow-lg">
                    <div className='d-flex justify-content-center flex-column align-items-center'>
                        <div className='row col-sm-12 col-md-12 col-lg-10 gap-4 py-4'>
                            <h5 class="maint pt-5">LOGIN AND START VOTING</h5>
                            <div class="mb-4">
                            ...
                            <div className='mt-3'>
                                <button type="submit" class="btn text-white form-b col-12 col-md-12 col-lg-12">Login</button>
                            </div>
